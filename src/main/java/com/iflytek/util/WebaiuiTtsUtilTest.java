 ...
 * 
 */
public class WebaiuiTtsUtilTest {
	
	private static final Logger logger = LoggerFactory.getLogger(WebaiuiTtsUtilTest.class);
...
//        		logger.info("webaiuUtil AUTH_ID{}",AUTH_ID);
	...
	public static void main(String[] args) throws IOException,ParseException, InterruptedException{
		...
		Map<String, String> header = buildHeader();
		String str = "坐姿通常是指人体在坐着时候的姿态。正确坐姿，除了遵循以下技巧摆放双腿外，还应时时保持上半身挺直的姿势，";//也就是颈、胸、腰都要保持平直。被测者挺胸被测者挺胸坐在被调节到腓骨头高度的平面上，头部以眼耳平面定位，眼睛平视前方，左、右大腿大致平行，膝弯屈大致成直角，足平放在地面上，手轻放在大腿上。!";//火落落，舞台礼仪？";//"北京明天的天气";
