...
public class Org extends DataEntity<Org> {
	...
	private Integer staffOn; // 1是，0否（是否上传了专职人员）
	private Integer qualificationOn;
	private Integer achieveOn;
	...
	public Integer getQualificationOn() {
		return qualificationOn;
	}

	public void setQualificationOn(Integer qualificationOn) {
		this.qualificationOn = qualificationOn;
	}

	public Integer getAchieveOn() {
		return achieveOn;
	}

	public void setAchieveOn(Integer achieveOn) {
		this.achieveOn = achieveOn;
	}
