...
public class UserController extends BaseController {
	...
	public String list(User user, HttpServletRequest request, 
        ...
        if(null != user && user.getOffice() != null && user.getCurrentUser() != null &&
        		user.getCurrentUser().getOffice() != null){
        	//user.getOffice().setName(user.getCurrentUser().getOffice().getName());
        	//System.out.println(user.getOffice().getName());
        	//System.out.println(user.getCurrentUser().getOffice().getName());
        }
        String officeId = (String)request.getParameter("office.id");
        if(null != user && user.getOffice() != null &&
        		StringUtils.isNotEmpty(officeId)){
        	Office officeTemp = officeService.get(officeId);
        	if(null != officeTemp && StringUtils.isNotEmpty(officeTemp.getId()) ){
        		user.getOffice().setName(officeTemp.getName());
        	}
        }
        if(null != user && user.getCurrentUser() != null && null != user.getCurrentUser().getOffice()){
        	//System.out.println("office.id" + user.getCurrentUser().getOffice().getId());
        }
