 ...
 */
package com.ambition.agile.common.codec;
...
import com.ambition.agile.common.lang.ExceptionUtils;
...
//	}
	...
	public static String encodeHtml(String html) {
		return null;//StringEscapeUtils.escapeHtml4(html);
	}
	...
	public static String decodeHtml(String htmlEscaped) {
		return null;//StringEscapeUtils.unescapeHtml4(htmlEscaped);
	}
	...
	public static String encodeXml(String xml) {
		return null;//StringEscapeUtils.escapeXml10(xml);
	}
	...
	public static String decodeXml(String xmlEscaped) {
		return null;//StringEscapeUtils.unescapeXml(xmlEscaped);
	}
