package com.ambition.agile.common.media;
...
import com.ambition.agile.common.io.FileUtils;
import com.ambition.agile.common.io.PropertiesUtils;
import com.ambition.agile.common.BaseConfigHolder;
import com.ambition.agile.common.collect.ListUtils;
import com.ambition.agile.common.lang.ObjectUtils;
...
public class VideoUtils {
	...
	public VideoUtils(String inputFile, String outputFile, String imgFile) {
		this.inputFile = inputFile;//FileUtils.path(inputFile);
		this.inputFileExtension = FileUtils.getFileExtension(inputFile);
		this.outputFile = outputFile;//outputFile != null ? FileUtils.path(outputFile) : inputFile + "." + outputFileExtension;
	...
	private int checkContentType() {
		...
		if (StringUtils.inString(inputFileExtension, "mp3","avi", "mpg", "wmv", "3gp", "mov",
