...
public class WxAcodeApiController extends BaseController {
	
	private final Logger logger = LoggerFactory.getLogger(WxAcodeApiController.class);
	...
	@ResponseBody
	public ApiResponse<?> acode(String code){
