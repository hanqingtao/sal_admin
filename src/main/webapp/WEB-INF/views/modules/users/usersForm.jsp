...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/users/users/">学员信息列表</a></li>
		<li class="active"><a href="${ctx}/users/users/form?id=${users.id}">学员信息<shiro:hasPermission name="users:users:edit">${not empty users.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="users:users:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
