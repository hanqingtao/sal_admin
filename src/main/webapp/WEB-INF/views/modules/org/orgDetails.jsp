...
<body> 
	...
	<ul class="nav nav-tabs">
		<li ><a href="javascript:history.go(-1);"> 代理机构列表  </a></li>
	    <li class="active"><a href="${ctx}/org/org/details?id=${org.id}">代理机构详细信息</a></li> 
	</ul><br/>
    ...
    <table class="table1">
     ...
     <tr>
            ...
            <td>${project.entrustMoney }万元</td>
            <td>${project.projectFlow.bidMoney }万元</td>
