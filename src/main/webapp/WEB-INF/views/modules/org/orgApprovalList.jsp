...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/org/org/listApprove">未审批代理机构列表</a></li>
		  
	</ul>
	<form:form id="searchForm" modelAttribute="org" action="${ctx}/org/org/listApprove" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="org">
			<tr>
				<td><a href="${ctx}/org/org/orgApprovedDatails?id=${org.id}">
					${org.name}
				</a></td>
				<td>
					${org.scCode}
				...
				<shiro:hasPermission name="org:org:edit"><td>
    				<a href="${ctx}/org/org/orgApprovedDatails?id=${org.id}">审批</a>
